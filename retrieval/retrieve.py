# https://github.com/jayrav13/bls_local_area_unemployment/blob/master/retrieve.py
...
response = requests.get(url, params={ k: v for k, v in data().items() if v is not None })
...
def doWork():
    while True:
        ...
        with open('data/pages/' + filename, 'w', encoding='utf-8') as f:
